      ...
      itinerary: {
        ...
        legs: [
          { mode: 'WALK', duration: 120, startTime: 0, endTime: 120000 },
          {
            ...
            headsign: 'North',
            blockId: 'block-7',
            from: { stopId: 'origin-stop', name: 'Origin Stop' },
            to: { stopId: 'terminal', name: 'Terminal' },
          },
          {
            mode: 'BUS',
            duration: 600,
            ...
            headsign: 'South',
            blockId: 'block-7',
            from: { stopId: 'terminal', name: 'Terminal' },
            to: { stopId: 'destination-stop', name: 'Destination Stop' },
          },
