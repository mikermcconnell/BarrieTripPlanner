...
| `DETOUR_MIN_UNIQUE_VEHICLES` | `2` | Minimum unique same-route confirming identities required before a detour is published. Trip IDs are preferred; weak one-point vehicle-only identities do not count. Values below 2 are ignored. |
