...
function buildDecision({ publishId, routeId, doc = {}, detour = {}, geometry = null, previousSnapshot = null, writeGeo = false, isNew = false, now = Date.now() }) {
  ...
  return {
    ...
    riderVisibilityPolicySource: doc.riderVisibilityPolicySource || null,
    riderVisibilityMissedOpportunityCount: doc.riderVisibilityMissedOpportunityCount ?? 0,
    riderVisibilityActiveServiceAgeMs: doc.riderVisibilityActiveServiceAgeMs ?? null,
    riderVisibilityMaxActiveServiceAgeMs: doc.riderVisibilityMaxActiveServiceAgeMs ?? null,
    riderVisibilityHeadwayMs: doc.riderVisibilityHeadwayMs ?? null,
    riderVisibilityDirectionId: doc.riderVisibilityDirectionId ?? null,
    riderVisibilityPassageTargetAvailable: doc.riderVisibilityPassageTargetAvailable === true,
    riderVisibilityFailSafeReason: doc.riderVisibilityFailSafeReason || null,
    alertVisible: doc.alertVisible === true,
    alertVisibilityReason: doc.alertVisibilityReason || null,
...
function shouldLogDecision(publishId, decisionRecord) {
  const signature = JSON.stringify({
    ...
    riderVisibilityPolicySource: decisionRecord.riderVisibilityPolicySource,
    riderVisibilityMissedOpportunityCount: decisionRecord.riderVisibilityMissedOpportunityCount,
    riderVisibilityActiveServiceAgeMs: decisionRecord.riderVisibilityActiveServiceAgeMs,
    alertVisible: decisionRecord.alertVisible,
    alertVisibilityReason: decisionRecord.alertVisibilityReason,
